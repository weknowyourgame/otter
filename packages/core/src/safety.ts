...
// `redis` as an explicit function parameter rather than importing a global
// client. apps/api constructs the real Redis-backed implementation and
// passes it in via EngineConfig.pauseStore; if the caller doesn't provide
// one, sessions are simply never paused.
